!(function (r) {
  ...
  r(window).on("load", function () {
    ...
    0 < r(".preloader").length &&
      r(".preloaderCls").each(function () {
    ...
    (r.fn.vsmobilemenu = function (t) {
      ...
      return this.each(function () {
        ...
        function a() {
          ...
          r(t).each(function () {
            r(this).hasClass(n.subMenuToggleClass) &&
              (r(this).removeClass(n.subMenuToggleClass),
              r(this).css("display", "none"),
              r(this).parent().removeClass(n.subMenuParentToggle));
          });
        }
        e.find("li").each(function () {
          ...
          t.addClass(n.subMenuClass),
            t.css("display", "none"),
            t.parent().addClass(n.subMenuParent),
            t.prev("a").addClass(n.meanExpandClass),
            t.next("a").addClass(n.meanExpandClass);
        });
        var t = "." + n.meanExpandClass;
        r(t).each(function () {
          r(this).on("click", function (t) {
            t.preventDefault(),
              0 < r((t = this)).next("ul").length
                ? (r(t).parent().toggleClass(n.subMenuParentToggle),
                  r(t).next("ul").slideToggle(n.toggleSpeed),
                  r(t).next("ul").toggleClass(n.subMenuToggleClass))
                : 0 < r(t).prev("ul").length &&
                  (r(t).parent().toggleClass(n.subMenuParentToggle),
                  r(t).prev("ul").slideToggle(n.toggleSpeed),
                  r(t).prev("ul").toggleClass(n.subMenuToggleClass));
          });
        }),
  ...
  r(window).on("scroll", function () {
    ...
    (t = r(".sticky-active")),
      ...
      (s = t.css("height")),
      t.parent().css("min-height", s),
      800 < r(window).scrollTop()
        ? (t.parent().addClass(a), i < n ? t.removeClass(e) : t.addClass(e))
        : (t.parent().css("min-height", "").removeClass(a), t.removeClass(e)),
      (i = n),
      500 < r(this).scrollTop()
        ? r(o).addClass("show")
    ...
    r(o).each(function () {
      r(this).on("click", function (t) {
        return (
          t.preventDefault(),
          r("html, body").animate({ scrollTop: 0 }, i / 3),
          !1
        );
      });
    }),
    0 < r("[data-bg-src]").length &&
      r("[data-bg-src]").each(function () {
        var t = r(this).attr("data-bg-src");
        r(this).css("background-image", "url(" + t + ")"),
          r(this).removeAttr("data-bg-src").addClass("background-image");
      }),
    0 < r("[data-bg-color]").length &&
    ...
    0 < r("[data-mask-src]").length &&
      r("[data-mask-src]").each(function () {
    ...
    r(".popup-video").magnificPopup({ type: "iframe" }),
    r(".popup-content").magnificPopup({ type: "inline", midClick: !0 }),
    (r.fn.sectionPosition = function (o, l) {
      r(this).each(function () {
        var t,
          ...
          s,
          i = r(this);
        (t = Math.floor(i.height() / 2)),
          (e = i.attr(o)),
          (a = i.attr(l)),
          (n = c(r(a).css("padding-top"))),
          (s = c(r(a).css("padding-bottom"))),
          "top-half" === e
            ? (r(a).css("padding-bottom", s + t + "px"),
              i.css("margin-top", "-" + t + "px"))
            : "bottom-half" === e &&
              (r(a).css("padding-top", n + t + "px"),
              i.css("margin-bottom", "-" + t + "px"));
      });
    });
  var e,
    t,
  ...
  r(d).length &&
      ...
      0 < r(t).length &&
        ...
        r(a).on("click", "button", function (t) {
          t.preventDefault(),
            ...
            r(this).siblings(".active").removeClass("active");
        }));
    }),
    r("#ship-to-different-address-checkbox").on("change", function () {
      r(this).is(":checked")
        ? r("#ship-to-different-address").next(".shipping_address").slideDown()
        : r("#ship-to-different-address").next(".shipping_address").slideUp();
    }),
    ...
    r(".shipping-calculator-button").on("click", function (t) {
      t.preventDefault(),
        r(this).next(".shipping-calculator-form").slideToggle();
    }),
    r('.wc_payment_methods input[type="radio"]:checked')
      .siblings(".payment_box")
      .show(),
    r('.wc_payment_methods input[type="radio"]').each(function () {
      r(this).on("change", function () {
        r(".payment_box").slideUp(),
          r(this).siblings(".payment_box").slideDown();
      });
    }),
    r(".rating-select .stars a").each(function () {
      r(this).on("click", function (t) {
        t.preventDefault(),
          r(this).siblings().removeClass("active"),
          r(this).parent().parent().addClass("selected"),
          r(this).addClass("active");
      });
    }),
    ...
    r(".cart-button").on("click", function (t) {
      t.preventDefault(),
        ...
        r(".shopping-cart-wrapper").toggleClass("show");
    }),
    ...
    r(".from").text("$" + r(".price_slider").slider("values", 0)),
    r(".to").text("$" + r(".price_slider").slider("values", 1)),
    (r.fn.indicator = function () {
      var s = r(this),
        t = s.find("a"),
        e = s.find("button");
      ...
      function n() {
        ...
        i.css({ top: n, left: t, width: a, height: e });
      }
      t.length ? (a = t) : e.length && (a = e),
    ...
    r(".filter-menu").length && r(".filter-menu").indicator(),
    r(".product-tab-style1").length && r(".product-tab-style1").indicator(),
    r(".tab-style2").length && r(".tab-style2").indicator(),
    r(".tab-style3").length && r(".tab-style3").indicator(),
    r(".tab-style5").length && r(".tab-style5").indicator(),
    r(".tab-style6").length && r(".tab-style6").indicator(),
    r(".tab-style7").length && r(".tab-style7").indicator(),
    r("[data-ani-duration]").each(function () {
    ...
    r(".vs-carousel")
      ...
      .on("afterChange", function (t, e, a, n) {
        r("[data-ani]").removeClass("vs-animated"),
          r(".slick-current [data-ani]").addClass("vs-animated");
      }),
    (e = ".sidemenu-wrapper"),
    (t = ".sideMenuCls"),
    (a = "show"),
    r(".sideMenuToggler").on("click", function (t) {
    ...
    (s = ".searchClose"),
    (l = "show"),
    r(".searchBoxToggler").on("click", function (t) {
    ...
    r(".counter-number").counterUp({ delay: 10, time: 1e3 }),
    (r.fn.shapeMockup = function () {
      r(this).each(function () {
        var t = r(this),
          ...
          n = t.data("bottom"),
          s = t.data("left");
        t.css({ top: e, right: a, bottom: n, left: s })
          .removeAttr("data-top")
    ...
    r(".shape-mockup") && r(".shape-mockup").shapeMockup(),
    r(".tilt-active").tilt({ maxTilt: 3, glare: !1, reverse: !0, scale: 1 }),
        ...
        var c = setInterval(function () {
          ...
          a < 10 && (a = "0" + a),
            ...
            e < 0
              ? (clearInterval(c),
                i.addClass("expired"),
                i.find(".message").css("display", "block"))
              : (l(".day").html(a),
                l(".hour").html(n),
                l(".minute").html(s),
                l(".seconds").html(t));
    ...
    r(".event-counter").length && r(".event-counter").countdown(),
